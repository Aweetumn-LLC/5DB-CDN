...
const Legal = () => {
  useEffect(() => {
    document.title = "Legal - FiveM Database CDN";
  }, []);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container py-8 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-center">FiveM Database CDN – Legal Notice & Terms of Service</h1>
        
        <div className="space-y-8 text-left">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-center">1. Corporate Registration and Jurisdiction</h2>
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">1.1</span> FiveM Database CDN is a service operating under and registered with the Velocity Network corporate structure.</p>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">2.1</span> FiveM Database CDN undertakes to maintain all user data in a secure environment in compliance with applicable UK data protection laws, including but not limited to the Data Protection Act 2018 and the UK GDPR.</p>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">3.1</span> By accessing or using the FiveM Database CDN platform, you acknowledge and agree to be bound by these Terms of Service, our Usage Policy, and our Data Usage Policy, as amended from time to time.</p>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              ...
              <p><span className="font-medium">4.3</span> FiveM Database CDN accepts no liability whatsoever for the legality, accuracy, or appropriateness of User Content, and all civil, criminal, and regulatory responsibility shall rest solely with the user.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">5.1</span> Upon receipt of a valid legal notice or takedown request, FiveM Database CDN may, at its sole discretion, remove or restrict access to the relevant content.</p>
              <p><span className="font-medium">5.2</span> Notwithstanding Clause 5.1, FiveM Database CDN reserves the right to retain the content in question until such time as any associated legal proceedings against the uploader are concluded.</p>
              <p><span className="font-medium">5.3</span> FiveM Database CDN shall have the final authority to determine whether any content remains hosted on the platform, save where otherwise directed by a binding judicial decision.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">6.1</span> FiveM Database CDN will only disclose user-identifying information, including usernames and email addresses, in response to:</p>
              <ul className="list-none ml-6 space-y-1">
                <li>a) A valid legal request issued by a competent law enforcement authority; or</li>
                <li>b) A binding order of a court with jurisdiction over FiveM Database CDN.</li>
              </ul>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">7.1</span> FiveM Database CDN operates solely as an image hosting provider enabling users to upload images and generate publicly shareable links.</p>
              <p><span className="font-medium">7.2</span> FiveM Database CDN does not pre-screen, monitor, or otherwise review uploaded content prior to publication.</p>
              <p><span className="font-medium">7.3</span> To the maximum extent permitted by law, FiveM Database CDN disclaims all warranties, express or implied, and shall not be liable for any loss, damage, claim, or liability arising from User Content.</p>
          ...
          <section>
            ...
            <div className="space-y-2 ml-4">
              <p><span className="font-medium">8.1</span> FiveM Database CDN reserves absolute discretion to determine whether content remains hosted on its platform following any legal process.</p>
